...
// HELPER: Holt die reine Bilderanzahl (identisch zum Immobilien-Template)
const getImageCountText = (packageName: string, packageImages?: number): string => {
  if (packageImages && packageImages > 0) return `${packageImages} High-End Aufnahmen`;
  const match = packageName.match(/(\d+)/);
  if (match) return `${match[1]} High-End Aufnahmen`;

  const mappings: Record<string, string> = {
    'Drohne S': '3-5 High-End Aufnahmen',
    'Drohne M': '8-10 High-End Aufnahmen',
    'Drohne L': '12-15 High-End Aufnahmen',
  };
...
export const DrohnenTemplate: React.FC<Props> = ({ data }) => {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.title}>
          <Text style={styles.h1}>Ihr Drohnenaufnahmen-Angebot</Text>
          <Text style={styles.greetingText}>
            {fullSalutation} {data.contact.lastName},
          </Text>
          <View style={{ marginBottom: 8 }} /> 
          <Text style={styles.greetingText}>
            vielen Dank für Ihr Interesse an unseren professionellen Drohnenaufnahmen.
          </Text>
          <Text style={styles.greetingText}>
          ...
          <View style={styles.projectGrid}>
            <View style={styles.projectColumn}>
              ...
              <View style={styles.projectItem}>
                ...
                <Text style={styles.projectValue}>Drohnen-Shooting</Text>
              </View>
            </View>
            <View style={styles.projectColumn}>
              <View style={styles.projectItem}>
              ...
              <View style={styles.projectItem}>
                ...
                <Text style={styles.projectValue}>{data.project.packageDuration || 'ca. 45-60 Min.'}</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.flexibilityNote}>
            <Text style={styles.flexibilityText}>
              Hinweis: Drohnenflüge sind wetterabhängig. Bei Regen oder starkem Wind vereinbaren wir kostenfrei einen Ausweichtermin.
            </Text>
          </View>
        </View>
