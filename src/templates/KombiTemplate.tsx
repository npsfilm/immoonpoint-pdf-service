...
const getImageCountText = (packageName: string, packageImages?: number): string => {
  ...
  // Mappings für Kombi-Pakete
  const mappings: Record<string, string> = {
    'Kombi S': '10 High-End Aufnahmen',
    'Kombi M': '15 High-End Aufnahmen',
    'Kombi L': '25 High-End Aufnahmen',
    'Kombi XL': '35 High-End Aufnahmen',
  };
          ...
          <View style={styles.projectGrid}>
            <View style={styles.projectColumn}>
              ...
              <View style={styles.projectItem}>
                ...
                <Text style={styles.projectValue}>Kombi (Foto & Drohne)</Text>
              </View>
            </View>
            <View style={styles.projectColumn}>
              <View style={styles.projectItem}>
              ...
              <View style={styles.projectItem}>
                ...
                <Text style={styles.projectValue}>{data.project.packageDuration || 'ca. 2.0 - 2.5 Std.'}</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.flexibilityNote}>
            <Text style={styles.flexibilityText}>
              Hinweis: Das Kombi-Paket bietet Ihnen das beste Preis-Leistungs-Verhältnis für eine lückenlose Vermarktung Ihrer Immobilie.
            </Text>
          </View>
        </View>
