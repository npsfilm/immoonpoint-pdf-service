      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.title}>
          ...
          <Text style={styles.intro}>
            vielen Dank für Ihr Interesse an unserem virtuellen Staging-Service.
          </Text>
        </View>
        ...
        <View style={styles.projectCard}>
          ...
          {roomCount > 0 && (
            <View style={styles.projectRow}>
              <Text style={styles.projectLabel}>Räume:</Text>
              <Text style={styles.projectValue}>{roomCount} Räume</Text>
            </View>
          )}
        </View>
