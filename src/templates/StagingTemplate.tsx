  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.title}>Ihr Virtual Staging Angebot</Text>
        
        <Text style={styles.greeting}>
          Guten Tag {data.contact.salutation} {data.contact.lastName},{'\n\n'}
          vielen Dank für Ihr Interesse an unserem virtuellen Home Staging Service.
        </Text>

        <View style={styles.projectCard}>
          <Text style={styles.projectTitle}>🏠 Virtual Staging Details</Text>
          ...
          {data.project.roomCount && (
            <View style={styles.projectRow}>
              <Text style={styles.projectLabel}>Anzahl Räume:</Text>
              <Text style={styles.projectValue}>{data.project.roomCount}</Text>
            </View>
          )}
        </View>
        ...
        <Text style={styles.footer}>ImmoOnPoint GmbH • www.immoonpoint.de • info@immoonpoint.de</Text>
      </Page>
    </Document>
  );
};
