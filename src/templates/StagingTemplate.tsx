...
const features = [
  "Digitale Möblierung nach Wunsch",
  "Fotorealistische 3D-Visualisierung",
  "Kommerzielle Nutzungsrechte",
  "Schnelle Lieferung",
];

export const StagingTemplate: React.FC<{ data: PdfData }> = ({ data }) => {
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.title}>Ihr Virtuelles Staging Angebot</Text>
        <Text style={styles.greeting}>
          Guten Tag {salutation} {data.contact.lastName},
        </Text>
        <Text style={styles.intro}>
          vielen Dank für Ihr Interesse an unserem Virtuellen Staging. Für Ihr Objekt in {city} erstellen wir fotorealistische Einrichtungsvisualisierungen:
        </Text>
